...
class ChainedReturnRebindingCanonicalOutputTest {

    @Test
    void chainedCrossServiceReturnRebindingShouldKeepOnlyLeafCanonicalPaths() {
        assertEquals(
                Set.of(
    ...
    private Set<String> analyzePaths() {
        ...
        MethodDeclaration method = sourceMethodResolver.resolve(
                SyntheticLombokScenarioService.class.getName(),
                "inspectDocumentWithChainedFinders",
                "document",
                RootDocument.class.getName()
        );
